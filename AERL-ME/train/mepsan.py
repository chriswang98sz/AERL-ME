...
def gradient_update(args, synced_model, returns, returns_with_entropy, random_seeds, neg_list,
    ...
    if KL <= args.delta or args.sigma < 0.5 * args.inisigma:
            args.sigma *= args.alpha
    elif KL > args.delta or args.sigma > 2 * args.inisigma:
            args.sigma /= args.alpha
...
def train_loop_meps_an(args, synced_model, env):
